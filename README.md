...
💻 𝑭𝒓𝒐𝒏𝒕-𝒆𝒏𝒅 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𝒘𝒉𝒐 𝒃𝒓𝒊𝒅𝒈𝒆𝒔 𝒂𝒓𝒕 𝒂𝒏𝒅 𝒄𝒐𝒅𝒆

🖌️ 𝑬𝒙𝒑𝒓𝒆𝒔𝒔𝒊𝒗𝒆 𝒂𝒓𝒕 | 🌐 𝑭𝒓𝒐𝒏𝒕-𝒆𝒏𝒅 𝒅𝒆𝒗 | ☕ 𝑪𝒐𝒇𝒇𝒆𝒆 𝒍𝒐𝒗𝒆𝒓

💡 𝑷𝒂𝒔𝒔𝒊𝒐𝒏𝒂𝒕𝒆 𝒂𝒃𝒐𝒖𝒕 𝒕𝒖𝒓𝒏𝒊𝒏𝒈 𝒆𝒎𝒐𝒕𝒊𝒐𝒏𝒔 𝒂𝒏𝒅 𝒊𝒅𝒆𝒂𝒔 𝒊𝒏𝒕𝒐 𝒗𝒊𝒔𝒖𝒂𝒍 𝒂𝒓𝒕 𝒂𝒏𝒅 𝒊𝒏𝒕𝒆𝒓𝒂𝒄𝒕𝒊𝒗𝒆 𝒘𝒆𝒃 𝒆𝒙𝒑𝒆𝒓𝒊𝒆𝒏𝒄𝒆𝒔.

---

## 𝗖𝘂𝗿𝗿𝗲𝗻𝘁𝗹𝘆 𝗳𝗼𝗰𝘂𝘀𝗶𝗻𝗴 𝗼𝗻

- 🎨 Building digital portfolios for artists  
- 🌐 Front-end projects using **HTML, CSS & JavaScript**  
- 🧠 Improving problem-solving with **C++ & Python**
